export const config = {
	mapTitle: 'female-employment', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-female-employment.vercel.app/', // The url provided when deploying the map on Vercel
